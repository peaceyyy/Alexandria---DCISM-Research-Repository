...
- Plan files are saved under root `docs/`, using the closest existing docs folder for the artifact type.
- Name derived from task (e.g., "add auth" -> `docs/plans/auth-feature.md`, or a phase-specific file under `docs/phases/[phase]/`).
- **NEVER** place generated project-facing plans inside `.agent/`, `.codex/`, `.claude/`, or temp folders unless the user explicitly asks.
