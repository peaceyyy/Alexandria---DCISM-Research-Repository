...
**Project Workflows output convention**: Root-cause notes and anti-pattern records generated by this workflow belong under root `docs/knowledge/`, not `.agent/` or `.codex/`.
...
2. Append to `docs/knowledge/anti-patterns/[anti-pattern-name].md`:
...
- Anti-pattern entry in `docs/knowledge/anti-patterns/`
