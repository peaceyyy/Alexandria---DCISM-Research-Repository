              ...
              {SUBMISSION_STATUS_OPTIONS.map((option) => {
                ...
                return (
                  <button
                    ...
                    disabled={isPending}
                    className={`flex min-h-11 cursor-pointer items-center justify-between rounded px-2 text-left text-[13px] transition-colors hover:bg-[var(--color-text)]/[0.05] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-brand)]/40 sm:min-h-9 disabled:pointer-events-none ${
